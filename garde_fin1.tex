...
\HRule \\[0.4cm]
\textcolor{blue}{ \LARGE \bfseries Déploiement de l'infrastructure IT et SI d'une entreprise et l'intégration des objets connectés au réseau}\\[0.4cm] % Title of your document
\HRule \\[1cm]
