...
Les étapes finales de vérification de la connexion entre le point d'accès TP-Link et le client TP-Link sont détaillées dans la figure et \ref{Chap2.3.11}.
