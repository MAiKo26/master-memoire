...
\HRule \\[0.4cm]
\textcolor{blue}{ \LARGE \bfseries Déploiement de l'infrastructure IT et SI d'une entreprise et l'intégration des objets connectés au réseau}\\[0.3cm] % Title of your document
\HRule \\[1cm]
...
Prénom NOM, Enseignant, ISTIC\\
Prénom NOM, Technicien, ZETA Engineering\\
Prénom NOM, Enseignant, ISTIC
\end{minipage}
